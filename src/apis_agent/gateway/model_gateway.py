...
from src.apis_agent.gateway.circuit_breaker import CircuitBreaker
from src.apis_agent.gateway.types import HealthRecord
...
class ModelGateway:
    ...
    async def start_probe(self, interval_seconds: float = 30.0):
        if self._probe_task is not None:
            return
        from src.apis_agent.gateway.health_probe import HealthProbe
