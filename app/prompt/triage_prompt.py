...
def _build_tool_section() -> str:
    ...
    from app.tool.tool_search import DEFERRED_TOOL_NAMES

    _CATEGORIES: dict[str, str] = {
        "app.tool.common": "通用工具",
        "app.tool.tavily_search": "联网搜索",
        "app.tool.bash_tool": "Shell 工具",
        "app.tool.file_system_tools": "文件系统",
        "app.tool.grep_tool": "代码搜索",
        "app.tool.skills_tool": "技能加载",
    }
